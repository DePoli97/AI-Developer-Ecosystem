...
- `rag-starter/` - laptop-friendly RAG (ingest, embed, store, retrieve, eval), no managed services required.
- `prompt-registry-starter/` - a tiny file-based prompt store with versioning, plus a TypeScript and Python client.

Status and rationale are tracked in `IDEAS.md` and `ROADMAP.md`.
